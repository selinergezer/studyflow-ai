...
def get_dashboard(
    ...
    # =========================================================
    # ÇALIŞMA SÜRELERİ
    # Kullanıcı çalışma süresini manuel olarak girer.
    # =========================================================
    ...
    try:
        ...
        ai_recommendation_result = {
            "message": ai_recommendation.message,
        ...
        ai_recommendation_result = {
            "message": "Şu anda AI önerisi oluşturulamadı.",
            "priority": "low",
            "recommended_action": "Derslerinden birini seçerek çalışmaya başlayabilirsin."
        }
